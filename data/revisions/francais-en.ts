...
content: {
definition:
"The part of speech of a word corresponds to its grammatical category. It never changes, even when the word changes position or role in a sentence. Understanding parts of speech helps improve grammar and sentence construction.",

formule:
"Noun • Verb • Adjective • Pronoun • Determiner • Adverb • Preposition • Conjunction • Interjection",

exemple:
"The black cat sleeps peacefully. (cat = noun, black = adjective, sleeps = verb, peacefully = adverb)",

pointsCles: [
"A noun names a person, animal, object or idea.",
...
erreurs: [
"Do not confuse part of speech and grammatical function.",
"A word can change function while keeping the same part of speech."
],

astuce:
"To identify the part of speech of a word, determine which grammatical family it belongs to."
},
},
...
content: {
definition:
"The grammatical function of a word indicates the role it plays in a sentence. Unlike its part of speech, its function can change depending on the sentence.",

formule:
"Subject • Verb • Direct Object • Indirect Object • Predicate",

exemple:
"Paul eats an apple. (Paul = subject, apple = direct object)",

pointsCles: [
"The subject performs the action.",
"The direct object completes the verb directly.",
"The indirect object is linked to the verb by a preposition.",
"The predicate gives information about the subject."
],

erreurs: [
"Do not confuse direct and indirect objects.",
"Do not confuse function and part of speech."
],

astuce:
"To find the subject, ask yourself: Who is performing the action?"
},
},
